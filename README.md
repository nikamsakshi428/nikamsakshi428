...
🎓 **Recently Completed:** Intensive Full Stack Java Developer Certification.
💡 **Focus:** Building scalable web applications using **Java**, **Spring Boot**, and **React**.
🔭 **Currently:** Developing portfolio projects and sharpening my problem-solving skills in **Data Structures & Algorithms**.
🌱 **Learning:** Expanding my knowledge in **Cloud Computing** and **Spring Microservices**.
💬 **Open to:** Entry-level software engineering roles or internship opportunities where I can contribute and grow.

📫 Reach me at: nikamsakshi908@gmail.com
🔗 LinkedIn: https://www.linkedin.com/in/sakshi-nikam-0266973a1?utm_source=share_via&utm_content=profile&utm_medium=member_android
